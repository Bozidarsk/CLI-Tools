...
class main 
{
	public static void Main(string[] args) 
	{
		...
		Console.Title = "HTML Server on: '" + directory + "'";
		new HTTPServer(new HTTPServer.ResponseMethod(HTTPServer.Response.GenerateHTMLResponse), directory, port, WebTools.GetLocalIP(), "HTML Server").Start();
	}
}